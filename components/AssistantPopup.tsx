...
import type { GroundingChunk, CalendarEvent, AISettings } from '../types';
...
const AssistantPopup: React.FC<AssistantPopupProps> = ({ onClose, aiSettings }) => {
    const { t } = useLanguage();
    ...
    }, [aiSettings.appIntegrationsEnabled, speak, t]);
    ...
    return (
        <div className="absolute bottom-full right-0 mb-2 w-[420px] h-[600px] max-h-[80vh] taskbar-background backdrop-blur-3xl ring-1 ring-black/10 dark:ring-white/10 rounded-xl shadow-2xl flex flex-col p-4 animate-fade-in-up text-outline">
